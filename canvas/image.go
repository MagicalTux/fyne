...
const (
	...
	// ImageScaleQuick will leave scaling to OpenGL in Linear mode
	ImageScaleQuick ImageScale = 2
	// ImageScaleUgly will leave scaling to OpenGL in Nearest mode
	ImageScaleUgly ImageScale = 3
)
